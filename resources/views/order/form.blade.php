        ...
        <div class="col-12 ">
            <div class="card-body d-flex justify-content-arround">
                <div class="col-md-6 p-3 d-flex align-items-center">
                    <div class="card p-3">
                        <!-- Product image-->
                        <img class="img-thumbnail w-100" src="{{ Storage::disk('public')->url( $product->gambar ) }}" alt="..." />
                    </div>
                </div>
                <!-- Product details-->
                    ...
                    <div class="card card-body">
                        ...
                        <form method="POST" action="{{ route('order.store') }}">
                            ...
                            <div class="form-group d-flex">
                                ...
                                <div class="col-md-6">
                                    <p class="fw-bold text-black">{{ $product->nama_produk }}</p>
                                </div>
                                <!-- Perbaikan: Menggunakan $product->id karena hanya satu produk yang diberikan -->
                                <input type="hidden" name="barang_id" id="barang_id" value="{{ $product->id }}" class="form-control" readonly>
                            </div>
                            <div class="form-group d-flex mt-3">
                                ...
                                <div class="col-md-6">
                                    <p class="fw-bold text-black">Rp. {{ number_format($product->harga) }}</p>
                                </div>
                            </div>
